...
vector<Production> productions = {
    Production("Start", {"Programs"}),
    Production("Programs", {"Programs", "Program"}),
    Production("Programs", {"Program"}),

    // Program产生式
    Production("Program", {"Type", "M", "idt", "(", "FormalParameters", ")", "M", "StatementBlock"}),
    ...
    // ParameterList产生式
    Production("ParameterList", {"Parameters"}),
    ...
    // Parameter产生式
    Production("Parameter", {"int", "M", "idt"}),
    ...
    Production("StatementSequence", {"StatementSequence", "M", "Statement"}), ///???????????????
    Production("StatementSequence", {"M", "Statement"}),
    ...
    Production("Factor", {"M", "idt"}),
    Production("Factor", {"M", "idt", "FTYPE"}),
    ...
    Production("FunctionCall", {"(", "void", ")"}),

    // ActualParameters产生式
    Production("ActualParameters", {"ActualParameterList"}),

    // ActualParameterList产生式
    Production("ActualParameterList", {"Expressions"}),
